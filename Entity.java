...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        //implement me!
        boolean inXRange = (this.x <= (other.getX() + other.getWidth())) && (other.x <= (this.getX()+ this.getWidth()) );
        boolean inYrange = (this.y <= (other.getY() + other.getHeight())) && (other.y <= (this.getY()+ this.getHeight()));
